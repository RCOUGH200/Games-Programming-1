...
void cSprite::otherUpdate(float deltaTime) 					// update position based on the translation
{
	D3DXVECTOR2 tempV2;
	D3DXVECTOR3 tempV3;
	tempV2 = getSpritePos2D() + (getTranslation())*deltaTime;
...
void cSprite::setBoundingRect(RECT* pRect)
{
	...
	if(getSTWidth()!=400){
		SetRect(pRect, (int)sPos.x, (int)sPos.y, (int)(getSTWidth()+sPos.x), (int)(getSTHeight()+sPos.y));
	}
	else
	{	
		SetRect(pRect, (int)sPos.x, (int)sPos.y, (int)(100+sPos.x), (int)(100+sPos.y));
	}
}
/*
=================
...
=================
*/
eDirection cSprite::getDirection()       // Rturns the current direction of the sprite
{
	return cSprite::mDirection;
}
/*
=================
...
=================
*/
void cSprite::setDirection(eDirection theDirection)  // Sets the current direction for the sprite.
{
	cSprite::mDirection = theDirection;
}